/**
 * @author: Hexastorm
 * @description: quick test to check communication with y stepper driver for the firestarter board v2
...
#define Y_MOTOR_STEP (GPIO_1_BASE | 12)   // Z_STEP 1|14 X_STEP PRU Y_STEP PRU
#define Y_MOTOR_DIR (GPIO_1_BASE | 15)    // Z_DIR  0|27  X_DIR 0|7 Y_DIR  1|15
#define STEPPER_ENABLE (GPIO_1_BASE | 28)
#define Y_MOTOR_SELECT (GPIO_0_BASE | 30) // CSZ 0|26, CSX spi chipselect, CSY 0|30

TMC2130Stepper driver = TMC2130Stepper(STEPPER_ENABLE, Y_MOTOR_DIR, Y_MOTOR_STEP, Y_MOTOR_SELECT);
